        ...
        <div class="flex items-center justify-center h-screen">
            <form class="w-full max-w-lg">
                ...
                <div class="flex flex-wrap -mx-20 mb-6">
                    ...
                    <label class="block uppercase tracking-wide text-gray-700 text-xs text-right font-bold mb-2" for="grid-modalidad">
                        Modalidad
                    </label>
                    <div class="relative">
       ...
       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
                ...
                <div class="flex items-center">
                    <div class="w-full md:w-3/4 flex-grow">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-comentario">Comentarios</label>
                        <textarea id="comentario" rows="4" class="block p-2.5 w-full text-sm text-black bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-200 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Añadir Comentario"></textarea>
                    </div>
                    <div class="ml-2">
