        ...
        <div className="flex items-center justify-center h-screen">
            <form className="w-full max-w-lg">
                ...
                <div className="flex flex-wrap -mx-20 mb-6">
                    ...
                    <label className="block uppercase tracking-wide text-gray-700 text-xs text-right font-bold mb-2" for="grid-modalidad">
                        Modalidad
                    </label>
                    <div className="relative">
                            <select className="block appearance-none w-full bg-gray-200 rounded-lg border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 shadow-lg" id="grid-modalidad">
                ...
                <div className="flex flex-wrap -mx-20 mb-6">
                    ...
                    <div className="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                        <label className="block uppercase tracking-wide rounded-lg text-gray-700 text-xs text-right font-bold mb-2" for="grid-enlace">
                            Enlace
                        </label>
                       
                        <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 shadow-lg" id="grid-last-name" type="text" placeholder=""/>                   
                    </div>
                ...
                <div className="flex flex-wrap -mx-20 mb-2">
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <label className="block uppercase tracking-wide text-gray-700 text-xs rounded-lg font-bold mb-2" for="grid-responsable">
                            Responsable
                        </label>
                        <div className="relative">
                    ...
                    <div className="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                        <label className="block uppercase tracking-wide text-gray-700 text-xs rounded-lg text-right font-bold mb-2" for="grid-asignarEquipo">
                            Semana
                        </label>
                        <div className="relative">
                            <select className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                ...
                <div className="flex flex-wrap -mx-20 mb-2">
                    <div className="w-full px-3 mb-6 md:mb-0">
                        ...
                        <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-foto">
                                Imágenes
                            </label>
                            <input className="block w-full text-sm text-gray-900 border border-gray-700 rounded-lg cursor-pointer bg-gray-700 dark:text-gray-700 focus:outline-none dark:bg-gray-200 dark:border-gray-600 dark:placeholder-gray-700" aria-describedby="user_avatar_help" id="user_avatar" type="file"/>
                    </div>
                </div> 

                <div className="flex items-center">
                    <div className="w-full md:w-3/4 flex-grow">
                        <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-comentario">Comentarios</label>
                        <textarea id="comentario" rows="4" className="block p-2.5 w-full text-sm text-black bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-200 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Añadir Comentario"></textarea>
                    </div>
                    <div className="ml-2">
                        <button type="button" className="text-black border border-blackhover:bg-black hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center dark:border-black dark:text-black dark:hover:text-white dark:focus:ring-black dark:hover:bg-black">
