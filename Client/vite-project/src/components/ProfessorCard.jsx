        ...
        <div className="bg-white shadow-xl rounded-lg py-3 ml-3 ">
            <div className="flex items-center justify-end mr-2">
              ...
              <div className="px-2">
                ...
                <div className="ml-4 flex items-end space-x-20">
                <div className="flex flex-col items-center">
                  ...
                  <label className="block  tracking-wide text-gray-700 text-xs font-bold mt-2" for="grid-branch">Cartago</label>
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <label className="block tracking-wide text-gray-700 text-xs font-bold mt-2" for="grid-branch">Ing.Computación</label>
                </div>
              </div>
